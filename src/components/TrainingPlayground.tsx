...
import type { TaskType, PongState, LogicGateState } from '../hooks/useSynapticSim';
...
export const TrainingPlayground: React.FC<TrainingPlaygroundProps> = ({
  ...
  useEffect(() => {
    ...
    ctx.fillText('SYNAPTIC AGENT HITS', canvas.width / 2 - 120, 15);
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#fff', display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              Synaptic Conditioning Playground
            </h2>
