...
A Swiss company called **FinalSpark** has already built an internet-connected "Neuroplatform" where universities around the world can remotely run experiments on living human brain organoids sitting in a lab in Switzerland. They call it **Synaptic-as-a-Service** — biology in the cloud.`,
  },
  {
    icon: Gamepad2,
...
Synaptic computers learn through these real biological mechanisms — no gradients, no loss functions, no epochs. Just cells, electricity, and chemistry.`,
  },
  {
    icon: HeartPulse,
    color: 'var(--accent-green)',
...
**📊 Silicon vs Biotech** — The benchmarks use real published figures from Nature and Frontiers in Science papers.`,
  },
  {
    ...
    color: 'var(--accent-cyan)',
    glow: 'var(--accent-cyan-glow)',
    title: 'Silicon vs. Synaptic: why it matters',
    emoji: '🔋',
